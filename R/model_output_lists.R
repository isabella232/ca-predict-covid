...
scenarios <- data.frame(
  ...
  label = c(
    ...
    'RAND: Reopen Non-essential Businesses in 2 weeks',
    'RAND: Reopen Bars/Restaurants/Large events in 1 month'
  ...
  descrip = c(
    ...
    "Maintain closed schools, bars, and restaurants; ban large events; close nonessential businesses; lift shelter-in-place order now, and 30 days from now adjusted activity levels relative to the previous level of intervention.",
    "Maintain closed schools, bars, and restaurants; ban large events; Open non-essential businesses in two weeks, and 30 days later, adjust activity levels relative to the previous level of intervention.",
    "Maintain closed schools; open  bars, and restaurants and permit large events in one month; and30 days after, adjust activity levels relative to the previous level of intervention."
  )
...
randlist <- as.list(as.character(scenarios[which(scenarios$group == "RD"),"colvar"]))
names(randlist) <- scenarios[which(scenarios$group == "RD"),"label"]
